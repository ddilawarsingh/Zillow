...
<script runat="server">
    ...
    void Reg_Route(RouteCollection rc)
    {
        //rc.MapPageRoute("lstagtprf","Agents/{agentname}/Profile","~/Agent/frmprf.aspx");
        //rc.MapPageRoute("lstagtprp","Agents/{agentname}/Properties","~/Agent/frmprp.aspx");
    }
